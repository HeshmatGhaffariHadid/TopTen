...
class HomeScreen extends StatelessWidget {
  ...
  Masjid(name: 'Masjid an-Nabawi' , description: 'Masji an-Nabawi is prophet\'s masjid which is located in Madina, Saudi Arabia, second holiest masjid in Islam, houses the tomb of Prophet Muhammad <PUH> and is a revered site for Muslims'),
    ...
    return Scaffold(
      ...
      body:ListView.builder(
        itemCount: masjids.length,
          ...
          return ClickableCard(name: masjid.name);
          }
      ),
    );
  }
